            ...
            <li className={" card-container " + weatherStatusHandler()}  >
                <div className="weather-card">
                    ...
                    <div className="features">
                        <div className="high">Temprature : <span>{    weather?.main?.temp ?   `${weather?.main?.temp_min}/${weather?.main?.temp_max}` : " N/A"}</span></div>
                        <div className="high">Humidity: <span>{weather?.main?.humidity ?? "N/A"}</span></div>
                        <div className="high">Pressure: <span>{weather?.main?.pressure ?? "N/A"}</span></div>
                    </div>
                </div>
            </li>
